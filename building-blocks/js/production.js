(() => {
  ...
  // No auto-scaled top padding — the earlier version added +60px of
  // sky per extra work beyond 4, which stacked to hundreds of pixels
  // of blank sky between the title and the first card once the list
  // grew past ~6. Charlie: 'theres a random amount of blank space
